...
check_prerequisites() {
    ...
    echo ""
    echo "1. \033[1mAuthenticator App Ready:\033[0m You MUST have an app (Google Auth, Authy, etc.) ready on your phone."
    echo "   - You will need to scan a QR code during this script."
    echo "   - \033[31mConsequence:\033[0m If you miss this, you cannot log in."
    echo ""
    echo "2. \033[1mSSH Public Key Present:\033[0m You MUST have an SSH Public Key in /root/.ssh/authorized_keys."
    echo "   - This script disables password authentication completely."
    echo "   - It copies the root key to your new admin user."
    echo "   - \033[31mConsequence:\033[0m If /root/.ssh/authorized_keys is empty/missing, your new user will have NO keys and NO password access."
    echo ""
    echo "3. \033[1mFresh Install:\033[0m This script is designed for a FRESH Debian 13 install."
    echo "   - \033[31mConsequence:\033[0m Running on an existing system may overwrite configs and break services."
    echo ""
